...
s.agree = "أتفق";
s.disagree = "لا أتفق";
s.pass = "تجاوز / غير متأكد";

s.modSpam = "محتوى غير مرغوب";
s.modOffTopic = "خارج عن سياق الموضوع";
s.modImportant = "مهم";
s.modSubmitInitialState = "تجاوز كل ما ذكر أعلاه, الى التعليق التالي";
s.modSubmit = "تم, التعليق التالي";

s.x_wrote = "كتب:";
s.x_tweeted = "غرد:";
s.group_123 = "مجموعة:";
s.majorityOpinion = "رأي الغالبية";
s.majorityOpinionShort = "الغالبية";
s.info = "معلومات";
s.addPolisToYourSite = "<img style='height: 20px; margin: 0px 4px;' src='{{URL}}'/>";
s.privacy = "الخصوصية";
s.TOS = "شروط الإستخدام";
s.writePrompt = "شارك وجهة نظرك....";
s.anonPerson = "مجهول";
s.helpWhatAmISeeingTitle = "مالذي أراه؟";
